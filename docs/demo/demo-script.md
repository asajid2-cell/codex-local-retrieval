...
|---|---|---|---|---|---|---|---|
| hero screenshot | `docs/assets/hero-screenshot.png` | archive reader with sanitized sample data | WinUI app screenshot | no local user path, no private transcript, no browser chrome | app built from this repo and sample store | README Demo section | Native archive reader with local sample data |
